...
function _bash-it-describe()
{
    ...
    for f in "${BASH_IT}/$subdirectory/available/"*.bash; do
        ...
        enabled_files=$(sort <(compgen -G "${BASH_IT}/enabled/*$BASH_IT_LOAD_PRIORITY_SEPARATOR${enabled_file}")                        \
                             <(compgen -G "${BASH_IT}/$subdirectory/enabled/${enabled_file}")                                           \
                             <(compgen -G "${BASH_IT}/$subdirectory/enabled/*$BASH_IT_LOAD_PRIORITY_SEPARATOR${enabled_file}") | wc -l)
